...
public interface Java9ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Java9Parser#superKeyword}.
	 * @param ctx the parse tree
	 */
	void enterSuperKeyword(Java9Parser.SuperKeywordContext ctx);
	/**
	 * Exit a parse tree produced by {@link Java9Parser#superKeyword}.
	 * @param ctx the parse tree
	 */
	void exitSuperKeyword(Java9Parser.SuperKeywordContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Java9Parser#purpose}.
	 * @param ctx the parse tree
	 */
	void enterPurpose(Java9Parser.PurposeContext ctx);
	/**
	 * Exit a parse tree produced by {@link Java9Parser#purpose}.
	 * @param ctx the parse tree
	 */
	void exitPurpose(Java9Parser.PurposeContext ctx);
	/**
	 * Enter a parse tree produced by {@link Java9Parser#methodPurpose}.
	 * @param ctx the parse tree
	 */
	void enterMethodPurpose(Java9Parser.MethodPurposeContext ctx);
	/**
	 * Exit a parse tree produced by {@link Java9Parser#methodPurpose}.
	 * @param ctx the parse tree
	 */
	void exitMethodPurpose(Java9Parser.MethodPurposeContext ctx);
	/**
